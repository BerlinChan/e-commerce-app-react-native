...
export default function FinishResetPwScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.id}>
        <CustomText style={styles.title}>Please check your mailbox.</CustomText>
      </View>

      <TouchableOpacity onPress={() => router.replace("/(auth)/signInSignUp")}>
